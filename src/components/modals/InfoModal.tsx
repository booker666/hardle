  ...
  return (
    <BaseModal title="How to play" isOpen={isOpen} handleClose={handleClose}>
      <p className="text-sm text-gray-500 dark:text-gray-300">
        Guess a 5 letter word in 10 tries. It's a harder version of wordle due
        to following features.
      </p>
      <p className="text-sm text-gray-500 dark:text-gray-300">
        1. Information will be masked, not all letters will be colored. Click
        the eye icon to disable this feature.
      </p>
      <p className="text-sm text-gray-500 dark:text-gray-300">
        2. Instead of showing green and yellow, only showing blue if a letter is
        in the answer. Click the unlock icon to disable this feature.
      </p>
      <p className="text-sm text-gray-500 dark:text-gray-300">
        3. There will be hints popping up after round 5, 7 and 9. Check the
        hints by clicking the lightbulb icon.
      </p>
      <p className="text-sm text-gray-500 dark:text-gray-300">
